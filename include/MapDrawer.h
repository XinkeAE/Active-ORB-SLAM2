...
public:
    ...
    void DrawMapFrontierCenter();
    void SetCurrentFrontierCenter(const std::vector<std::vector<float>> &frontierCenter);
...
private:
    ...
    std::vector<std::vector<float>> mFrontierCenters;
    float mKeyFrameSize;
    ...
    std::mutex mMutexFrontierCenter;
};
